...
import { Eye, Calendar, FileText, CheckCircle, XCircle, Clock, Download } from "lucide-react";
import { formatDate } from "../../utils/formatDate";
import { exportToExcel, formatSubmissionsForExport } from "../../utils/excelExport";

export default function CompanyAdminSubmissions() {
  const { user } = useAuth();
  ...
  const loadSubmissions = async () => {
    try {
      ...
      if (response.success) {
        // Filter submissions for this company if needed
        const companySubmissions = user?.companyId
          ? response.data.filter(sub => sub.companyId === user.companyId)
          : response.data;
  ...
  const handleExport = () => {
    ...
    exportToExcel(dataToExport, "Company_Submissions", "Submissions");
  };
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 animate-fade-in">
            <div>
              ...
              <p className="text-gray-600">View and manage form submissions for your company</p>
            </div>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold">Plant</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {submissions.map((submission, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-gray-600">{submission.plantName || "N/A"}</td>
