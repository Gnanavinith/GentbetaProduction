...
async function testCaching() {
  try {
    ...
    console.log('✅ Cache warming result:', warmedData ? 'SUCCESS' : 'FAILED');
    ...
    if (stats) {
      ...
      console.log('⚠️  Cache stats not available (Redis might not be configured)');
    }
    
    // Test pattern deletion
    console.log('\n4. Testing pattern deletion...');
    const deleteResult = await deleteFromCache('test:*');
    console.log('✅ Deleted pattern result:', deleteResult);
